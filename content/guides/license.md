...
Applies to all source code: `cmd/`, `cli/`, `internal/`, `go.mod`, `go.sum`, `Makefile`, `scripts/`.
...
Full license text: [LICENSE-CODE](license-code.html) · [gnu.org](https://www.gnu.org/licenses/gpl-3.0.html)

---

## Content — Creative Commons Attribution-ShareAlike 4.0 International

Applies to all educational content: `content/`.
